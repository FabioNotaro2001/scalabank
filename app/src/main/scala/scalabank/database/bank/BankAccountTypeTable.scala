...
/**
 * Trait representing the operations for the bank account type table.
 */
trait BankAccountTypeTable extends DatabaseOperations[BankAccountType, String]

/**
 * Object for creating instances of BankAccountTypeTable.
 */
object BankAccountTypeTable:
  
  /**
   * Creates a new instance of BankAccountTypeTable.
   *
   * @param connection The database connection to use.
   * @param database The database reference.
   * @return A new instance of BankAccountTypeTable.
   */
  def apply(connection: Connection, database: Database): BankAccountTypeTable = BankAccountTypeTableImpl(connection, database)

  private class BankAccountTypeTableImpl(override val connection: Connection, override val database: Database) extends BankAccountTypeTable:
