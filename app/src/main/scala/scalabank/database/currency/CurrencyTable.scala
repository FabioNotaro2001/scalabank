...
/**
 * Represent the operations for the currency table.
 */
trait CurrencyTable extends DatabaseOperations[Currency, String]

/**
 * Object for creating instances of CurrencyTable.
 */
object CurrencyTable:

  /**
   * Creates a new instance of CurrencyTable.
   * @param connection The database connection to use.
   * @param database The database reference.
   * @return A new instance of CurrencyTable.
   */
  def apply(connection: Connection, database: Database): CurrencyTable = CurrencyTableImpl(connection, database)

  private class CurrencyTableImpl(override val connection: Connection, override val database: Database) extends CurrencyTable:
