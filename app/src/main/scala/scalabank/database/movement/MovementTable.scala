...
/**
 * Represent the operations for the movements table.
 */
trait MovementTable extends AbstractCache[Movement, (Int, String)] with DatabaseOperations[Movement, (Int, LocalDateTime)]:
  def findByBankAccount(bankAccId: Int): Seq[Movement]
/**
 * Object for creating instances of MovementTable.
 */
object MovementTable:

  /**
   * Creates a new instance of MovementTable.
   *
   * @param connection The database connection to use.
   * @param database The database reference.
   * @return A new instance of MovementTable.
   */
  def apply(connection: Connection, database: Database): MovementTable = MovementTableImpl(connection, database)

  private class MovementTableImpl(override val connection: Connection, override val database: Database) extends MovementTable:
    import database.*
     ...
     */
    override def findByBankAccount(bankAccId: Int): Seq[Movement] =
