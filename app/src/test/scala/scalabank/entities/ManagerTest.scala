...
class ManagerTest extends AnyFunSuite:
  ...
  test("Manager should remove a project correctly"):
    val project = Project("Project A", 50000.0, List())
    val manager = Manager("John", "Doe", 1980, Manager.ManagerPosition.TeamLead, 2010, List(project))
  ...
  test("Manager should calculate the correct project budget"):
    ...
    val manager = Manager("John", "Doe", 1980, Manager.ManagerPosition.TeamLead, 2010, List(projectA, projectB))
  ...
  test("List of Managers should calculate the total projects managed correctly"):
    ...
    val manager1 = Manager("John", "Doe", 1980, Manager.ManagerPosition.TeamLead, 2010, List(projectA))
    val manager2 = Manager("Jane", "Smith", 1985, Manager.ManagerPosition.DepartmentHead, 2015, List(projectB, projectC))
