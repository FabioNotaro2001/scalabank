...
class EmployeeTest extends AnyFunSuite with BeforeAndAfterEach:
  ...
  test("An Employee should be correctly initialized and age calculated"):
    val employee = Employee("JHNDOE22B705Y", "John", "Doe", 1990, EmployeePosition.FinancialAnalyst, 2000)
  ...
  test("An Employee salary calculated"):
    val employee = Employee("JHNDOE22B705Y", "John", "Doe", 1990, Employee.EmployeePosition.FinancialAnalyst, 2000)
    employee.salary shouldBe 1500.0

  test("Employee should calculate annual salary correctly"):
    val cashier = Employee("JHNDOE22B705Y", "John", "Doe", 1990, Employee.EmployeePosition.Cashier, 2000)
    val financialAnalyst = Employee("JHNDOE22B705Y", "Jane", "Smith", 1985, Employee.EmployeePosition.FinancialAnalyst, 2000)
  ...
  test("fullName should return the full name of the employee"):
    val employee = Employee("JHNDOE22B705Y", "John", "Doe", 1990, EmployeePosition.Cashier, 2000)
  ...
  test("Employee should calculate annual salary with standard bonus correctly"):
    ...
    val employee = Employee("JHNDOE22B705Y", "John", "Doe", 1980, EmployeePosition.Cashier, 2010)
  ...
  test("Employee should calculate annual salary with senior bonus correctly"):
    ...
    val employee = Employee("JHNDOE22B705Y", "Jane", "Doe", 1980, EmployeePosition.FinancialAnalyst, 2010)
  ...
  test("List of employees should calculate total annual salary correctly"):
    val employee1 = Employee("JHNLCA22B705Y", "Alice", "Johnson", 1992, EmployeePosition.Cashier, 2000)
    val employee2 = Employee("JHNDOE22B705Y", "Bob", "Williams", 1993, EmployeePosition.FinancialAnalyst, 2000)
  ...
  test("allJobCategories should return a list of annual salaries for all employees"):
    val employee1 = Employee("JHNDOE22B705Y", "John", "Doe", 1990, EmployeePosition.Cashier, 2000)
    val employee2 = Employee("JHADOE22B705Y", "Jane", "Smith", 1985, EmployeePosition.FinancialAnalyst, 2000)
    val employees = List(employee1, employee2)
  ...
  test("yearsOfService should calculate the correct years of service"):
    val employee = Employee("JHNDOE22B705Y", "John", "Doe", 1990, Employee.EmployeePosition.Cashier, 2000)
